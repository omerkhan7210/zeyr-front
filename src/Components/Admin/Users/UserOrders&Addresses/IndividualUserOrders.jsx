...
import { OrderRows } from '../../OrdersDetails/OrdersRow';
import { hostLink } from '../../../Hostlink/hostlink';
import axios from 'axios';

export const IndividualUserOrders = () => {
  const {userID} = useContext(AdminContextC)
...
const handleFilter = (newFilterOptions) => {
  ...
  const fetchTotalOrders = async () => {
    try {
      const response = await axios.get(`${hostLink}/fetch-completed-order-user/${userID}`);
  ...
  return (
    ...
    <div className="app-content-header">
      <h1 className="app-content-headerText">Orders For User ID: {userID}</h1>
      <ToggleSwitchButton/>
    </div>
    <OrdersFilter 
