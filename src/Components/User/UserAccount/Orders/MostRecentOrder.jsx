...
export const MostRecentOrder = ({mostRecentOrder}) => {
  return (
    <div className="tableView products-area-wrapper " style={{borderBottom:'1px solid rgba(0,0,0,0.2)' ,paddingBottom:'1rem', marginBottom:'1rem'}}>
        
        <h6 className='variant-heading' style={{marginLeft:0,marginBottom:'1rem'}}>Recent Order</h6>
    ...
    {mostRecentOrder &&
         <OrderRowsMyAccount order={mostRecentOrder} key={mostRecentOrder.id}/>
        }
        </div>
  )
}
