    ...
    <>
      ...
      >
        ...
        <div class="input-wrapper">
          <label class="visually-hidden" htmlFor="AddressFirstNameNew">
            First name
          </label>
          <input
            type="text"
        ...
        <div class="input-wrapper">
          <label class="visually-hidden" htmlFor="AddressLastNameNew">
            Last name
          </label>
          <input
            type="text"
        ...
        <div class="input-wrapper">
          <label class="visually-hidden" htmlFor="AddressCompanyNew">
            Company
          </label>
          <input
            type="text"
        ...
        <div class="input-wrapper">
          <label class="visually-hidden" htmlFor="AddressAddress1New">
            Address 1
          </label>
          <input
            type="text"
        ...
        <div class="input-wrapper">
          <label class="visually-hidden" htmlFor="AddressAddress2New">
            Address 2
          </label>
          <input
            type="text"
        ...
        <div class="input-wrapper">
          <label class="visually-hidden" htmlFor="AddressCityNew">
            City
          </label>
          <input
            type="text"
        ...
        <div>
          <label class="visually-hidden" htmlFor="AddressCountryNew">
            Country/region
          </label>
          <div class="select">
            <select
        ...
        <div id="AddressProvinceContainerNew" style={{ display: "none" }}>
          <label class="visually-hidden" htmlFor="AddressProvinceNew">
            Province
          </label>
          <div class="select">
            <select
        ...
        <div class="input-wrapper">
          <label class="visually-hidden" htmlFor="AddressZipNew">
            Postal/ZIP code
          </label>
          <input
            type="text"
        ...
        <div class="input-wrapper">
          <label class="visually-hidden" htmlFor="AddressPhoneNew">
            Phone
          </label>
          <input
            type="phone"
