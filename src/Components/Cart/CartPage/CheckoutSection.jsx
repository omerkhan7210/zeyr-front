...
export const CheckoutSection = ({ totalPrice }) => {
  
  const {selectedCurrencyLocale,selectedCurrencyCode} = useContext(ProductFetchContext);
  return (
    <div
      id="shopify-section-template--14963723468865__cart-footer"
      className="shopify-section cart__footer-wrapper"
    >
      <div
        className="page-width"
        id="main-cart-footer"
        data-id="template--14963723468865__cart-footer"
      >
        <div>
            ...
            <div className="cart__blocks">
              <div className="js-contents">
                <div className="totals">
                  ...
                  <p className="totals__subtotal-value"><PriceFormatter price={totalPrice} locale={selectedCurrencyLocale} currencyCode={selectedCurrencyCode}/>
</p>
                </div>
                <div />
                <small className="tax-note caption-large rte">
                  <span>Taxes </span>Calculated at checkout{" "}
                </small>
              </div>
              <div className="cart__ctas">
                <noscript>
                  &lt;button type="submit" class="cart__update-button button
                  button--secondary" form="cart"&gt; Update &lt;/button&gt;
                </noscript>
                <Link
                  type="submit"
                  id="checkout"
                  className="cart__checkout-button btn btn--primary giftbox-checkout"
                  name="checkout"
                  to="/checkout"
                  style={{
                ...
                <Link
                  type="submit"
                  id="checkout"
                  className="cart__checkout-button btn btn--primary giftbox-checkout giftbox-checkout-cloned"
                  name="checkout"
                  to="/checkout"
                >
                  Checkout
                  ...
                  <div>
                    <div className="shopify-cleanslate">
                      <div
                        ...
                        className="R9tDu8JrE_i1ctOEo0v_"
                        aria-hidden="true"
                      >
                        <svg
                    ...
                    <div className="shopify-cleanslate">
                      <div className="Jk692hbroeK5lg6b_t4v usE9L3hgsurjyQqHttzR">
                        <ul
                          className="p28_J2fRvZNDqyZkZ2H9"
                          data-shopify-buttoncontainer="true"
                          role="list"
                        >
                          <li
                            className="Vru56DW5IUIiRpxbGTDg"
                            data-testid="grid-cell"
                          >
                            <div
                              role="button"
                              tabIndex={0}
                              className="kqsiVA9Jf8LJAbxw8Bau h7OYsWHrW5495r9beh2n IcgSIE7pEVZrlnAeRS6j DnvZqPMEvBFbBre5UuP9 size--small"
                              data-testid="ShopifyPay-button"
                            >
                              <span className="Xrk_DudB6JJ3t2Kh2_cU">
                                {" "}
                                ShopPay
                              </span>
                              <span className="ElVMgDjOgshGFMIvg3se">
                                <svg
                                  preserveAspectRatio="xMidYMid"
                                  className="qZgSr5RiiBCTAMfQYsty"
                                  style={{ height: 20, width: 85 }}
                                >
                                  <use xlinkHref="#shopify-svg__payments-shop-pay" />
                                </svg>
                              </span>
                            </div>
                          </li>
                          ...
                          >
                            <div
                              role="button"
                              tabIndex={0}
                              className="kqsiVA9Jf8LJAbxw8Bau h7OYsWHrW5495r9beh2n IcgSIE7pEVZrlnAeRS6j vKjZTx5He86dhWbWaFxE size--small"
                            ...
                            >
                              ...
                              <span className="ElVMgDjOgshGFMIvg3se">
                                <svg
                                  preserveAspectRatio="xMidYMid"
                                  className="qZgSr5RiiBCTAMfQYsty"
                                  style={{ height: 20, width: "45.2632px" }}
                                >
                                  <use xlinkHref="#shopify-svg__payments-google-pay-light" />
                                </svg>
                              </span>
                            </div>
                          </li>
